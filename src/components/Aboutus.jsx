  ...
  return (
    <div className="tw-bg-white tw-dark:tw-bg-gray-900 tw-p-10 tw-rounded-xl tw-shadow-2xl tw-mx-auto tw-max-w-6xl tw-mt-16 tw-mb-16">
      ...
      <p className="tw-text-lg tw-text-gray-700 tw-dark:tw-text-gray-300 tw-mb-6 tw-leading-relaxed">
        Welcome to <span className="tw-font-bold tw-text-yellow-500">QuickBite</span>! We are passionate about bringing you the best culinary experiences from around the world. Whether you're craving Indian classics like Chole Bhature and Dosa, or delicious Italian pizzas, we have something to satisfy every palate.
      </p>
      <p className="tw-text-lg tw-text-gray-700 tw-dark:tw-text-gray-300 tw-mb-6 tw-leading-relaxed">
      ...
      <p className="tw-text-lg tw-text-gray-700 tw-dark:tw-text-gray-300 tw-mb-6 tw-leading-relaxed">
        Thank you for choosing <span className="tw-font-bold tw-text-yellow-500">QuickBite</span>. We hope you have a delicious experience with us!
      </p>
      <div className="tw-flex tw-justify-center tw-mt-10">
        <img src={LOGO} alt="QuickBite Logo" className="tw-w-40 tw-h-40 tw-object-contain"/>
      </div>
